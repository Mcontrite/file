...
func Client() *oss.Client {
	...
	if err != nil {
		fmt.Println("OSS Client Error: ", err.Error())
		return nil
	}
	return ossCli
}
...
func Bucket() *oss.Bucket {
	...
	if cli != nil {
		...
		if err != nil {
			fmt.Println("OSS Bucket Error: ", err.Error())
			return nil
		}
		return bucket
	}
...
func DownloadURL(objName string) string {
	...
	if err != nil {
		fmt.Println("OSS DownloadURL Error: ", err.Error())
		return ""
	}
	return signedURL
}
...
func BuildLifecycleRule(bucketName string) {
	...
	fmt.Println("Excuting BuildLifecycleRule OK...")
}
...
func GenObjectMeta(filename string) []oss.Option {
	...
	fmt.Println("Excuting GenObjectMeta OK...")
	return options
}
