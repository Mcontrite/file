...
func main() {
	username := "root"
	token := "b3b10b41cc3254c58af8e6554075800460a1ec79"
	filehash := "eec8fdae6e6c8bd2ff0fe8e40059467e2ba7b950"
	fsize := "48961296"
	...
	// 3. 请求分块上传接口
	filename := "D:/Zips/Git-2.30.2-64-bit.exe"
	...
	resp, err = http.PostForm(
		...
		url.Values{
			...
			"filehash": {filehash},
			"filesize": {fsize},
			"filename": {"Git-2.30.2-64-bit.exe"},
			"uploadid": {uploadID},
		})
